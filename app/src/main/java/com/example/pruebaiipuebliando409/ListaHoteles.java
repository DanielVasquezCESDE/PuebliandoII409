...
*/
    ...
    public void llenarListaConDatos () {
        ...
        listaHoteles.add(new MoldeHotel("Hotel cabañal La Palma", "$1", "3005068890", R.drawable.hotelcabanialapalma, "Experimenta la tranquilidad de la naturaleza en nuestra hacienda con vistas panorámicas a las montañas. Disfruta de habitaciones acogedoras y actividades al aire libre. Ideal para escapadas románticas.", 2.7f, "Una belleza, se ve que le ponen amor a la cocina =)", "Elena D"));
        listaHoteles.add(new MoldeHotel("Hotel Copamar", "$2", "3234543232", R.drawable.hotelcopamar, "Sumérgete en la cultura cafetera en esta auténtica finca antioqueña. Rodeada de cafetales, ofrece alojamientos rústicos y recorridos por la plantación. Perfecta para amantes del café y la naturaleza.", 4.5f, "¡Increíble experiencia! Las habitaciones eran cómodas y la vista desde el balcón era impresionante. Definitivamente volveré", "Pedro N"));
        listaHoteles.add(new MoldeHotel("Hotel Copacabana", "$3", "3234543232", R.drawable.hoteldecopacabana, "Enclavado en el corazón de un bosque encantado, nuestro hotel boutique ofrece elegantes habitaciones con vista al río. Relájate en el spa o aventúrate en senderos ecológicos. Una experiencia de lujo en la naturaleza.", 3.2f, "El servicio al cliente fue excepcional. Siempre atentos a nuestras necesidades. Me sentí como en casa", "Andrea M"));
        listaHoteles.add(new MoldeHotel("Hotel LibertGHotel", "$5", "3234543232", R.drawable.hotellibertghotelsspa, "Vive la experiencia de alojarte en cabañas de madera rodeadas de exuberante vegetación. Perfecto para familias o grupos, con actividades como paseos a caballo y fogatas nocturnas. Un refugio acogedor en la montaña.", 2.2f, "El ambiente tranquilo y relajante hizo que mi estancia fuera perfecta. Sin duda, un lugar para desconectar del ajetreo de la ciudad.", "Luis R"));
        listaHoteles.add(new MoldeHotel("Hotel Villa Camila", "$8", "3234543232", R.drawable.hotelvillacamila, "Esta posada emana encanto rural en cada rincón. Con jardines floridos y piscina al aire libre, es el lugar ideal para desconectar. Ofrecemos deliciosa comida casera y un ambiente acogedor para toda la familia.", 1.5f, "La ubicación es inmejorable, cerca de todo lo que queríamos visitar. Además, el desayuno era delicioso. Recomendado", "Isabel S"));
    }
}